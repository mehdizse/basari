  ...
  Widget _getColumnBody() => Column(
        children: <Widget>[
                    ...
                    children: [
                      ...
                      TextSpan(
                          ...
                          style: TextStyle(
                              ...
                              fontWeight: FontWeight.w700)),
                      TextSpan(
                        text: ' المرسلة إلى هاتفك المحمول',
                        style: TextStyle(
          ...
          Row(
            ...
            children: <Widget>[
              getPinField(key: "1", focusNode: focusNode6),
              SizedBox(width: 5.0),
              getPinField(key: "2", focusNode: focusNode5),
              SizedBox(width: 5.0),
              getPinField(key: "3", focusNode: focusNode4),
              SizedBox(width: 5.0),
              getPinField(key: "4", focusNode: focusNode3),
              SizedBox(width: 5.0),
              getPinField(key: "5", focusNode: focusNode2),
              SizedBox(width: 5.0),
              getPinField(key: "6", focusNode: focusNode1),
              SizedBox(width: 5.0),
            ],
          ),
...
//          autofocus: key.contains("1") ? true : false,
  ...
  onStarted() {
    _showSnackBar("بدا تسجيل الدخول بالهاتف");
//    _showSnackBar(phoneAuthDataProvider.message);
  }

  onCodeSent() {
    _showSnackBar("تم ارسال كلمة السر");
//    _showSnackBar(phoneAuthDataProvider.message);
  }

  onCodeResent() {
    _showSnackBar("تم اعادة ارسال كلمة السر");
  }
  ...
  onAutoRetrievalTimeOut() {
    _showSnackBar("نفد وقت تسجيل الدخول بالهاتف");
  }
}
